          ...
          <View style={styles.modalContent}>
            ...
            <View style={{ backgroundColor: '#0a0a0a', padding: 10, borderRadius: 10, marginBottom: 20 }}>
              <Text style={{ color: '#888' }}>
                Wallet: <Text style={{ color: 'white' }}>${user.balance}</Text>
              </Text>
              <Text style={{ color: '#888' }}>
                Vault: <Text style={{ color: 'white' }}>${user.vault}</Text>
              </Text>
            </View>
            <TextInput
            ...
            <TouchableOpacity onPress={() => setVaultModal(false)} style={{ marginTop: 20 }}>
...
const styles = StyleSheet.create({
  ...
  loginBox: {
    ...
    borderRadius: 20,
    borderTopWidth: 3,
    borderTopColor: LONE_STAR_GOLD,
    shadowColor: LONE_STAR_GOLD,
    shadowOpacity: 0.2,
    shadowRadius: 20,
  },
  title: {
    color: LONE_STAR_GOLD,
    fontSize: 28,
    fontWeight: '900',
    textAlign: 'center',
    marginBottom: 40,
  ...
  goldButton: {
    backgroundColor: LONE_STAR_GOLD,
    padding: 18,
    borderRadius: 10,
    alignItems: 'center',
    shadowColor: LONE_STAR_GOLD,
