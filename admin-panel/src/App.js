      ...
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '100vh', backgroundColor: '#1a1a1a', color: 'white', fontFamily: 'sans-serif' }}>
        <form onSubmit={handleLogin} style={{ backgroundColor: '#2a2a2a', padding: '2rem', borderRadius: '8px', width: '300px' }}>
          ...
          <div style={{ marginBottom: '1rem' }}>
            ...
            <input id="username" type="text" value={username} onChange={e => setUsername(e.target.value)} style={{ width: '100%', padding: '8px', marginTop: '5px' }} />
          </div>
          <div style={{ marginBottom: '1rem' }}>
            <label htmlFor="password">Password</label>
            <input id="password" type="password" value={password} onChange={e => setPassword(e.target.value)} style={{ width: '100%', padding: '8px', marginTop: '5px' }} />
          </div>
          <button type="submit" disabled={authLoading} style={{ width: '100%', padding: '10px', backgroundColor: '#d4af37', border: 'none', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold', opacity: authLoading ? 0.7 : 1 }}>
        ...
        <section>
          <div style={{ backgroundColor: '#1e1e1e', padding: '1.5rem', borderRadius: '8px', marginBottom: '2rem' }}>
            ...
            <form onSubmit={createPlayer}>
              <input aria-label="Username" placeholder="Username" value={newPlayer.username} onChange={e => setNewPlayer({ ...newPlayer, username: e.target.value })} style={{ width: '100%', padding: '10px', marginBottom: '10px', background: '#333', border: 'none', color: 'white' }} />
              <input aria-label="Initial Password" placeholder="Initial Password" value={newPlayer.password} onChange={e => setNewPlayer({ ...newPlayer, password: e.target.value })} style={{ width: '100%', padding: '10px', marginBottom: '10px', background: '#333', border: 'none', color: 'white' }} />
              <button disabled={loading} style={{ width: '100%', padding: '10px', backgroundColor: '#d4af37', border: 'none', cursor: 'pointer', opacity: loading ? 0.7 : 1 }}>
